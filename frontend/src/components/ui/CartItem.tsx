...
export const CartItem: FC<CartItemProps> = ({
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-4 p-4 pr-4 sm:pr-8 justify-between items-center sm:items-stretch w-full min-h-[180px]">
            <div className="flex items-center gap-4 w-full sm:w-auto">
                ...
                <div className="flex flex-col justify-between flex-1 py-3 max-w-full sm:max-w-[600px]">
                    <div>
            ...
            <div className="flex justify-between items-center gap-4 w-full sm:w-auto mt-4 sm:mt-0">
